...
@section('content')
        ...
        <div class="h-full overflow-hidden pl-10">
            <main id="dashboard-main" class="h-[calc(100vh-1rem)] overflow-auto px-4 py-10">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <h1 class="text-xl text-white bg-gray-400 px-4 py-2 font-semibold w-48">TABLE BUKU</h1>
                        ...
                        <tbody>
                            @foreach ($buku as $item)
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        {{ $item->details->f_status }}
                                    </td>
                                    <td class="px-6 py-4">
                                        <a href="/dashboard/buku/edit/{{ $item->f_id }}"
    ...
    <a href="/dashboard/buku/tambah"
        class="fixed text-white bottom-4 right-4 bg-blue-500 px-4 py-2 rounded hover:bg-blue-700 focus:outline-none"><i
            class="fa-light fa-circle-plus"></i> Tambah Buku</a>
    <script src="https://code.jquery.com/jquery-3.7.1.js" integrity="sha256-eKhayi8LEQwp4NKxN+CfCh+3qOVUtJn3QNZ0TciWLP4="
        crossorigin="anonymous"></script>
    <script>
        $('button[data-modal-toggle="delete-popup"]').click(function() {
            var id = $(this).data('id');
            var href = "/dashboard/buku/delete/" + id;
