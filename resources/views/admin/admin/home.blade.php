        ...
        <div class="h-full overflow-hidden pl-10">
            <main id="dashboard-main" class="h-[calc(100vh-1rem)] overflow-auto px-4 py-10">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <h1 class="text-xl text-white bg-gray-400 px-4 py-2 font-semibold w-48">TABLE ADMIN</h1>
                        ...
                        <tbody>
                            @foreach ($admins as $item)
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="/dashboard/admin/edit/{{ $item->f_id }}"
                                            class="text-white hover:bg-green-700 bg-green-400 rounded-md px-4 py-2">Edit</a>
